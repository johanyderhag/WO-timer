...
var app = (function () {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function startTimer() {
    		...
    		$$invalidate(3, timer = convertMS$2(timerTime));

    		interval = setInterval(
    			() => {
    				$$invalidate(3, timer = convertMS$2(timerTime - 1));
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ convertMS: convertMS$1 });
    	return [];
    }
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 85, 4, 1953);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$3, 92, 13, 2170);
    			...
    			add_location(input, file$3, 94, 14, 2258);
    			attr_dev(div0, "class", "input-div");
    			add_location(div0, file$3, 93, 12, 2219);
    			attr_dev(span1, "class", "span-right svelte-fnpv5w");
    			add_location(span1, file$3, 103, 12, 2499);
    			attr_dev(label, "for", "work");
    			attr_dev(label, "class", "svelte-fnpv5w");
    			add_location(label, file$3, 91, 10, 2138);
    			attr_dev(div1, "class", "input-1 svelte-fnpv5w");
    			add_location(div1, file$3, 90, 8, 2105);
    			attr_dev(div2, "class", "input-2 svelte-fnpv5w");
    			add_location(div2, file$3, 108, 8, 2677);
    			attr_dev(form, "class", "svelte-fnpv5w");
    			add_location(form, file$3, 89, 6, 2052);
    			add_location(div3, file$3, 88, 4, 2039);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = text(/*timer*/ ctx[1]);
    			attr_dev(a, "href", "index.html");
    			add_location(a, file$3, 79, 2, 1753);
    			attr_dev(p0, "class", "svelte-fnpv5w");
    			add_location(p0, file$3, 80, 2, 1784);
    			attr_dev(nav, "class", "svelte-fnpv5w");
    			add_location(nav, file$3, 78, 0, 1744);
    			attr_dev(div, "class", "container svelte-fnpv5w");
    			add_location(div, file$3, 82, 0, 1809);
    			attr_dev(p1, "class", "timer svelte-fnpv5w");
    			add_location(p1, file$3, 116, 0, 2796);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function tMinusTen() {
    		setState(state.countdown, "yellow");
    		timerTime = 10;
    		$$invalidate(1, timer = convertMS$1(timerTime));

    		interval = setInterval(
    			() => {
    				$$invalidate(1, timer = convertMS$1(timerTime - 1));
    				timerTime -= 1;
